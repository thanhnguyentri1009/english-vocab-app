...
import SpeakingLevelSelect from "./SpeakingLevelSelect";
...
} from "../../data/english/exercises";
import { SPEAKING_LEVELS } from "../../data/english/speaking/sentences";
import {
  findTopicForLevel,
  getLevelsForTopic,
