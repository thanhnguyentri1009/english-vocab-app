    ...
    >
      <Card style={{ maxWidth: 360, width: '100%', borderRadius: 16, textAlign: 'center' }}>
        ...
        <Text style={{ color: '#8a97a3', display: 'block', marginBottom: 20 }}>
          Enter a name or code to save your learning progress. Use the same
          code on every device to keep them in sync.
        </Text>
        <Input
          size="large"
        ...
        <Button type="primary" block size="large" onClick={handleSubmit} loading={checking}>
          Continue
        </Button>
      </Card>
    </div>
